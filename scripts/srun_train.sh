...
# Normal
srun -u -w gpic08 --gres=gpu:2,gpumem:12G -p gpi.compute -o $output --time 23:59:59 --mem 50G python3 ~/PixInWav2/src/main.py --beta $beta --lam $lam --lr $lr --summary $summary --experiment $experiment --from_checkpoint $from_checkpoint --transform $transform --ft_container $ft_container --mp_encoder $mp_encoder --mp_decoder $mp_decoder --mp_join $mp_join
