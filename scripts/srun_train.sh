...
# Develop
srun -u -w gpic07 --gres=gpu:2,gpumem:12G -p gpi.develop -o $output --time 1:59:59 --mem 50G python3 ~/PixInWav2/src/trainer_rgb.py --beta $beta --lr $lr --summary $summary --experiment $experiment --from_checkpoint $from_checkpoint --add_l1_term $add_l1_term --transform $transform --ft_container $ft_container --mp_encoder $mp_encoder --mp_decoder $mp_decoder --mp_join $mp_join
